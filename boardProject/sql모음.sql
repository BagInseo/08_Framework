...
CREATE TABLE "MEMBER" (
	...
	"MEMBER_NICKNAME"	NVARCHAR2(10)		NOT NULL,
	"MEMBER_TEL"	CHAR(11)		NOT NULL,
	"MEMBER_ADDRESS"	NVARCHAR(300)		NULL,
...
COMMENT ON COLUMN "BOARD"."BOARD_NO" IS '게시판 번호(PK)';
...
CREATE TABLE "UPLOAD_FILE" (
	...
	"FILE_ORIGINAL_NAME"	VARCHAR2(300)		NOT NULL,
	"FILE_RENAME"	VARCHAR2(100)		NOT NULL,
	"FILE_UOLOAD_DATE"	DATE	DEFAULT SYSDATE	NOT NULL,
	"MEMBER_NO"	NUMBER		NOT NULL,
...
COMMENT ON COLUMN "UPLOAD_FILE"."FILE_ORIGINAL_NAME" IS '파일원본명';

COMMENT ON COLUMN "UPLOAD_FILE"."FILE_RENAME" IS '파일 변경명';

COMMENT ON COLUMN "UPLOAD_FILE"."FILE_UOLOAD_DATE" IS '업로드 날짜';
...
COMMENT ON COLUMN "BOARD_LIKE"."BOARD_NO" IS '게시판 번호(PK)';
...
COMMENT ON COLUMN "BOARD_IMG"."BOARD_NO" IS '게시판 번호(PK)';
...
COMMENT ON COLUMN "COMMENT"."BOARD_NO" IS '게시판 번호(PK)';
...
ALTER TABLE "BOOK" ADD CONSTRAINT "PK_UNTITLED" PRIMARY KEY (
	"BOOK_NO"
);
...
INSERT INTO "BOOK"
VALUES(SEQ_BOOK_NO.NEXTVAL,'테스트중(제목)','글쓴이1',25000,DEFAULT);

INSERT INTO "BOOK"
VALUES(SEQ_BOOK_NO.NEXTVAL,'테스트중2(제목)','글쓴이2',45000,DEFAULT);


SELECT *
FROM "BOOK"
WHERE BOOK_TITLE LIKE'%테%';
...
--DBMS_RANDOM.VALUE(0,3) : 0.0이상 ,3.0미만의 난수 
 ...
 * + 좋아요 개수
 **/
-- 번호 / 제목[댓글 개수] / 작성자닉네임 /조회수 / 좋아요 개수 / 작성일
...
SELECT  SYSDATE - BOARD_WRITE_DATE
FROM "BOARD";
...
--현재 시간 - 하루 전
SELECT (SYSDATE  - TO_DATE('2020-04-10 12:14:30','YYYY-MM-DD HH24:MI:SS'))*60*60*24
FROM DUAL;
...
INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL,'/images/board/','원본1.jpg','test1.jpg',0,1996);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL,'/images/board/','원본2.jpg','test2.jpg',1,1996);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL,'/images/board/','원본3.jpg','test3.jpg',2,1996);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL,'/images/board/','원본4.gif','test4.gif',3,1996);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL,'/images/board/','원본5.gif','test5.gif',4,1996);
...
SELECT BOARD_NO ,BOARD_TITLE ,BOARD_CONTENT, BOARD_CODE,READ_COUNT,
		...
		(SELECT COUNT(*) FROM "BOARD_LIKE"
		 WHERE BOARD_NO=1996)LIKE_COUNT,
...
CUSTOMER_DEL_FL	CHAR(1)	DEFAULT 'N'	NOT NULL
...
VALUES(SEQ_CUSTOMER_NO.NEXTVAL, '홍길동', '01012341234','경기도 일산',DEFAULT);

SELECT * FROM CUSTOMER;

UPDATE CUSTOMER
SET CUSTOMER_NAME ='홍길동',
	CUSTOMER_TEL='01011112222',
	CUSTOMER_ADDRESS='경기도 일산'
WHERE CUSTOMER_NO ='1';
...
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'member01@kh.or.kr',
	...
	-- 여러 행을 항번에 삽입하는 방법 -> insert + sebquery
	INSERT INTO "BOARD_IMG"
	(SELECT 100,'경로','원본1','변경1',1,1996 FROM DUAL);
...
(
SELECT NEXT_IMG_NO(),'경로','원본1','변경1',1,1996 FROM DUAL
UNION
SELECT NEXT_IMG_NO(),'경로2','원본2','변경2',2,1996 FROM DUAL
UNION
SELECT NEXT_IMG_NO(),'경로3','원본3','변경3',3,1996 FROM DUAL
);

SELECT * FROM "BOARD_IMG";

SELECT BOARD_TITLE, BOARD_NO ,BOARD_DEL_FL ,BOARD_CODE 
FROM "BOARD"
...
INSERT INTO "COMMENT" VALUES
		(SEQ_COMMENT_NO.NEXTVAL ,'부모 댓글1',
		DEFAULT,DEFAULT,2014,5,NULL);
	
INSERT INTO "COMMENT" VALUES
		(SEQ_COMMENT_NO.NEXTVAL ,'부모 댓글2',
		DEFAULT,DEFAULT,2014,5,NULL);
	
INSERT INTO "COMMENT" VALUES
		(SEQ_COMMENT_NO.NEXTVAL ,'부모 댓글3',
		DEFAULT,DEFAULT,2014,5,NULL);
	
SELECT * FROM "COMMENT" WHERE BOARD_NO =2014;
...
INSERT INTO "COMMENT" VALUES
		(SEQ_COMMENT_NO.NEXTVAL ,'부모 1의 자식1',
		DEFAULT,DEFAULT,2014,5,2010);
	
INSERT INTO "COMMENT" VALUES
		(SEQ_COMMENT_NO.NEXTVAL ,'부모 1의 자식2',
		DEFAULT,DEFAULT,2014,5,2010);
	
INSERT INTO "COMMENT" VALUES
		(SEQ_COMMENT_NO.NEXTVAL ,'부모 2의 자식1',
		DEFAULT,DEFAULT,2014,5,2011);
	
INSERT INTO "COMMENT" VALUES
		(SEQ_COMMENT_NO.NEXTVAL ,'부모 2의 자식1의 자식1',
		DEFAULT,DEFAULT,2014,5,2019);
...
/*계층형 쿼리*/
-- PARENT_COMMETN_NO 값이 NULL인 행이 부모(LV.1)
START WITH PARENT_COMMENT_NO IS NULL
...
WHERE BOARD_TITLE  LIKE '%처음%';
	...
	SELECT BOARD_NO,BOARD_TITLE,USER_NAME,BOARD_CONTENT,BOARD_READCOUNT,
