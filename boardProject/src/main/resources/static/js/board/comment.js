...
const selectCommentList=()=>{
    ...
    .then(commentList=>{
        ...
        //화면에 존재하는 기존의 댓글 목록 삭제 후 
        // 조회된 commentList를 이용해서
        // 새로운 댓글 목록을 출력

        const ul = document.querySelector("#commentList") //ul태그(댓글 목록을 감싸는 요소)
        ul.innerHTML=""; //기존 댓글 목록 삭제

        /* 조회된 commentList를 이요해 댓글 출력 */
        for(let comment of commentList){
            ...
            //대댓글(자식 댓글)인 경우 "child-comment" 클래스 생성
